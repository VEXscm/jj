...
glob:"stacks/*" | glob:"refs/stacks/*"))`. Vex Change and Stack refs are
review bookmarks, not published history, so they stay editable. For example,
to also consider the `release@origin` bookmark immutable:
